...
//   return (
//     <div className="container mx-auto p-6 bg-[#FFF5E6]">
//       <h1 className="text-3xl font-bold mb-6">
//         Instant Dive into Your Performance Metrics
//       </h1>

//       <Tabs defaultValue="lifetime" className="mb-6">
//         <TabsList>
...
//           <TabsTrigger value="custom">Customize Time Line</TabsTrigger>
//         </TabsList>
//       </Tabs>
...
//               <span className="text-sm font-normal">Total Orders: 394</span>
//             </CardTitle>
//           </CardHeader>
//           <CardContent>
...
//         <Card className="bg-[#B8860B] text-white">
//           <CardHeader>
//             <CardTitle>Star Facts about your orders!!!</CardTitle>
//           </CardHeader>
//           <CardContent>
...
//             </ul>
//             <Button className="mt-4 bg-white text-[#B8860B] hover:bg-gray-100">
//               Check Orders Page
//             </Button>
//           </CardContent>
//         </Card>
...
//                 <CardContent className="flex items-center justify-between p-4">
//                   <div>
//                     <p className="text-sm font-medium">Tracking Page Views</p>
